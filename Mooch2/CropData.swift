...
enum CropType: Int, Codable, CaseIterable {
    ...
    var info: CropInfo {
        ...
        case .corn:
            return CropInfo(
                name: "Corn", sfSymbol: "sun.max.fill", emoji: "🌽", color: Color(hex: "F5C518"),
        ...
        case .cotton:
            return CropInfo(
                name: "Cotton", sfSymbol: "cloud.fill", emoji: "🪡", color: Color(hex: "F0F0F0"),
        ...
        case .sorghum:
            return CropInfo(
                name: "Sorghum", sfSymbol: "leaf.fill", emoji: "🌾", color: Color(hex: "C8A93A"),
                smokeSensitivity: .low, harvestWindowHours: 48,
                seasonNote: "Robust grain crop with minimal smoke sensitivity during grain fill.",
                smokeAQIThreshold: 150, valuePerAcre: 2000)
        case .soybeans:
            return CropInfo(
                name: "Soybeans", sfSymbol: "circle.hexagongrid.fill", emoji: "🫘", color: Color(hex: "7BA05B"),
        ...
        case .barley:
            return CropInfo(
                name: "Barley", sfSymbol: "wind", emoji: "🌾", color: Color(hex: "D4B483"),
                smokeSensitivity: .low, harvestWindowHours: 48,
                seasonNote: "Head fully enclosed — lower smoke exposure than open-canopy crops.",
                smokeAQIThreshold: 150, valuePerAcre: 2000)
        case .winterWheat:
            return CropInfo(
                name: "Winter Wheat", sfSymbol: "snowflake", emoji: "🌾", color: Color(hex: "E8D5A3"),
                smokeSensitivity: .low, harvestWindowHours: 48,
                seasonNote: "Dormant winter growth highly resistant to smoke particulate damage.",
                smokeAQIThreshold: 150, valuePerAcre: 2000)
        case .alfalfa:
            return CropInfo(
                name: "Alfalfa", sfSymbol: "leaf.arrow.circlepath", emoji: "🌿", color: Color(hex: "5B8C3E"),
        ...
        case .tomatoes:
            return CropInfo(
                name: "Tomatoes", sfSymbol: "drop.fill", emoji: "🍅", color: Color(hex: "E84040"),
        ...
        case .grapes:
            return CropInfo(
                name: "Grapes", sfSymbol: "hexagon.fill", emoji: "🍇", color: Color(hex: "7B3F9E"),
        ...
        case .oranges:
            return CropInfo(
                name: "Oranges", sfSymbol: "circle.fill", emoji: "🍊", color: Color(hex: "FF8C00"),
                smokeSensitivity: .moderate, harvestWindowHours: 30,
        ...
        case .cherries:
            return CropInfo(
                name: "Cherries", sfSymbol: "suit.heart.fill", emoji: "🍒", color: Color(hex: "C0392B"),
        ...
        case .peaches:
            return CropInfo(
                name: "Peaches", sfSymbol: "oval.fill", emoji: "🍑", color: Color(hex: "FFAA6E"),
                smokeSensitivity: .high, harvestWindowHours: 16,
                seasonNote: "Fuzz traps particulates and smoke taint penetrates within hours of peak ripeness.",
                smokeAQIThreshold: 100, valuePerAcre: 2000)
        case .pistachios:
            return CropInfo(
                name: "Pistachios", sfSymbol: "pentagon.fill", emoji: "🫘", color: Color(hex: "8FBC4E"),
                smokeSensitivity: .moderate, harvestWindowHours: 24,
                seasonNote: "Split shells during harvest allow ash into the nut — hull integrity matters.",
                smokeAQIThreshold: 150, valuePerAcre: 2000)
        case .strawberries:
            return CropInfo(
                name: "Strawberries", sfSymbol: "heart.fill", emoji: "🍓", color: Color(hex: "E8314E"),
        ...
        case .olives:
            return CropInfo(
                name: "Olives", sfSymbol: "leaf", emoji: "🫒", color: Color(hex: "808000"),
                smokeSensitivity: .moderate, harvestWindowHours: 30,
                seasonNote: "Waxy olive skin resists particulates but prolonged smoke alters oil flavor profile.",
                smokeAQIThreshold: 150, valuePerAcre: 2000)
        case .pomegranates:
            return CropInfo(
                name: "Pomegranates", sfSymbol: "plus.circle.fill", emoji: "🍎", color: Color(hex: "C0225A"),
        ...
        case .lettuce:
            return CropInfo(
                name: "Lettuce", sfSymbol: "leaf.fill", emoji: "🥬", color: Color(hex: "4CAF50"),
        ...
        case .unknown:
            return CropInfo(
                name: "Unknown Crop", sfSymbol: "questionmark.circle", emoji: "❓", color: Color(hex: "9E9E9E"),
                smokeSensitivity: .moderate, harvestWindowHours: 24,
